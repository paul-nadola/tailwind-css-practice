    ...
    <div className='w-full mt-24 bg-slate-900 text-gray-300 py-8 px-2'>
        <div className='max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8'>
            ...
            <div className='col-span-2 pt-8 md:pt-2'>
                ...
                <p className='py-4'>The latest news, articles, and resources sent to ypur inbox weekly.</p>
                <form className='flex flex-col sm:flex-row'>
                    <input className= 'w-full p-2 mr-4 rounded-md mb-4 text-indigo-800 font-bold' type="email" placeholder='enter your email address'/>
        ...
        <div className='flex flex-col max-w-[1240px] px-2 py-4 m-auto items-center justify-between sm:flex-row text-center text-gray-500'>
            <p>2023 Nadola Ent, LLC. all rights reserved</p>
